<template>
    ...
    <div class="mt-6" v-for="pricing in props.pricingCollection">
        ...
        <div class="flex">
            <Card class="m-4" style="width: 300px; height: 400px; overflow: hidden" v-for="product in pricing.products">
                <template #content>
                    <p class="text-green-600 text-2xl font-bold">{{ product.name }}</p>
                    <p class="text-xl font-bold">{{ product.price }} VND</p>
                    <p>{{product.subtitle}}</p>
                    <div style="height: 210px" v-html="product.description">
                    </div>
                </template>
                <template #footer>
    ...
    <Dialog v-model:visible="visible" modal header="Product detail" :style="{ width: '800px' }">
        ...
        <div class="flex align-items-center gap-3 mb-5">
            <Galleria :value="detailProduct.image" :numVisible="4">
...
import StripeCheckout from "../../component/StripeCheckout.vue";
