<template>
    ...
    <div class="card mt-4">
        <Tabs value="0">
            <TabList>
                <Tab value="0">Daily Access</Tab>
                <Tab value="1">Monthly Access</Tab>
                <Tab value="2">Yearly Access</Tab>
            </TabList>
            <TabPanels>
                <TabPanel value="0">
                    <Chart type="bar" :data="dayChartData" :options="chartOptions" class="w-full"/>
                </TabPanel>
                <TabPanel value="1">
